...
def check_hint(clue, hint):
    if (clue == 3):
        ...
        return hashlib.md5(hint.encode()).hexdigest() in ['0512868916a7081afcfb789198de0f37', '865726b2885feef8e8b25b56a2d7c8f8', '4ab7d471b85d867f917bf1a97f4224ec', '98309965d401e673ce9f638cbcfcbea3']
    elif (clue == 9):
